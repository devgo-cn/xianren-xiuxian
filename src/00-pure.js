 ...
 * 锚: base_atk×1.375(攻速×暴击期望) ≈ 达标dps×20%; hp/def ≈ 达标×25%。 */
const BASE_STATS = [ // [atk, hp, def] 按大境界(凡人→天仙)
  [76, 616, 12],            // 凡人
  [300, 2470, 50],          // 炼气
  [1200, 9880, 200],        // 筑基
  [4800, 39600, 800],       // 结丹
  [19000, 158150, 3195],    // 元婴
  [77000, 633350, 12800],   // 化神
  [310000, 2532000, 51150], // 炼虚
  [1240000, 10172000, 205500], // 合体
  [5000000, 40540000, 819000], // 大乘
  [20000000, 161900000, 3270000], // 渡劫
  [79000000, 649000000, 13110000], // 真仙
  [316000000, 2600000000, 52500000], // 天仙
];
