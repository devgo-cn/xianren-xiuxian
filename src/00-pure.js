...
/* v5.18 通关节奏重定标: 境界停留 = 推图卡图(12~30分) + 修为积累, 全程 ~145h 日历。
 * 锚点: 炼气 3.5h 起, 单调递增 → 天仙 24h(刚晋升绝不可能几小时通关)。
 * 旧表 [0.15,2.5,...,32] 为月级长线节奏, 与 v5.17 推图提速(10.5h→3.5h)脱节 ——
 * sim-v60.js(推图+修为复合口径, 丹方覆盖0.6/兽潮余威2.8/聚灵阵递推) 反解收敛。 */
const REALM_DAYS = [0.15, 0.52, 0.75, 0.95, 1.23, 1.44, 1.61, 1.77, 2.21, 2.42, 2.85, 3.27];
