...
function attrAssign(art, kind, q, pow) {        // 装备数值 + 词条
  /* v5.17 三围=境界定值(eqStatsAssign: 基准×EQ_POW, 无随机/无品质乘子) ——
   * 同境界同部位三围恒定; 品质价值全部走词条(fxCount 条数 / fxValue 数值 / 极品概率)。 */
  eqStatsAssign(art, kind, pow);
